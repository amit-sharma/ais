...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(metropolisC(x, beta, num_iterations_mcmc, other_params));
    return __result;
END_RCPP
}
// metropolisC2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< List >::type other_params(other_paramsSEXP);
    __result = Rcpp::wrap(metropolisC2(x, beta, num_iterations_mcmc, rproposal_fn_xpsexp, dproposal_fn_xpsexp, other_params));
    return __result;
END_RCPP
}
// metropolisCbeta
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(metropolisCbeta(x, beta, num_iterations_mcmc, rproposal_fn_xpsexp, dproposal_fn_xpsexp, other_params, debug));
    return __result;
END_RCPP
}
// faC
...
BEGIN_RCPP
    ...
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type e(eSEXP);
    __result = Rcpp::wrap(JacobianC(e));
    return __result;
END_RCPP
}
// logJacobianC
...
BEGIN_RCPP
    ...
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type e(eSEXP);
    __result = Rcpp::wrap(logJacobianC(e));
    return __result;
END_RCPP
}
// log_likelihoodC
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(log_likelihoodC(theta, powers_dirichlet, theta_sum_list));
    return __result;
END_RCPP
}
// e_to_pC
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type e(eSEXP);
    Rcpp::traits::input_parameter< List >::type other_params(other_paramsSEXP);
    __result = Rcpp::wrap(fbC(e, other_params));
    return __result;
END_RCPP
}
// rproposal_distr
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(rproposal_distr(x, n, mult));
    return __result;
END_RCPP
}
// dbeta_cond_distr
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type n(nSEXP);
    Rcpp::traits::input_parameter< double >::type mult(multSEXP);
    __result = Rcpp::wrap(dbeta_cond_distr(x, y, n, mult));
    return __result;
END_RCPP
}
// putFunPtrInXPtr
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(putFunPtrInXPtr(distr_name));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< std::string >::type distr_name(distr_nameSEXP);
    __result = Rcpp::wrap(getCondDensityFuncXPtr(distr_name));
    return __result;
END_RCPP
}
// rcpp_hello_world
